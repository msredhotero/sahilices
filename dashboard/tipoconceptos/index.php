...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../tipoconceptos/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Tipo de Conceptos",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Tipo de Concepto";

$plural = "Tipo de Conceptos";

$eliminar = "eliminarTipoconceptos";

$insertar = "insertarTipoconceptos";
...
<script>
	$(document).ready(function(){
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=tipoconceptos",
			"language": {
