...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../motivosoportunidades/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Motivos de Oportunidades",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Motivo de Oportunidad";

$plural = "Motivos de Oportunidades";

$eliminar = "eliminarMotivosoportunidades";

$insertar = "insertarMotivosoportunidades";
...
<script>
	$(document).ready(function(){
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=motivosoportunidades",
			"language": {
