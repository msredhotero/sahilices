...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../tipoclientes/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Tipo de Clientes",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
$plural = "Tipo de Clientes";

$eliminar = "eliminarTipoclientes";

$insertar = "insertarTipoclientes";
...
<script>
	$(document).ready(function(){
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=tipoclientes",
			"language": {
