...
$plural = "Tipo de Trabajos";

$eliminar = "eliminarTipostrabajos";

$insertar = "insertarTipostrabajos";
...
<script>
	$(document).ready(function(){
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=tipostrabajos",
			"language": {
