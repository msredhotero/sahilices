...
$serviciosSeguridad->seguridadRuta($_SESSION['refroll_sahilices'], '../tipomoneda/');
//*** FIN  ****/

$fecha = date('Y-m-d');

//$resProductos = $serviciosProductos->traerProductosLimite(6);
$resMenu = $serviciosHTML->menu($_SESSION['nombre_sahilices'],"Tipo de Monedas",$_SESSION['refroll_sahilices'],$_SESSION['email_sahilices']);
...
$plural = "Tipo de Monedas";

$eliminar = "eliminarTipomonedas";

$insertar = "insertarTipomonedas";
...
<script>
	$(document).ready(function(){
		var table = $('#example').DataTable({
			"bProcessing": true,
			"bServerSide": true,
			"sAjaxSource": "../../json/jstablasajax.php?tabla=tipomonedas",
			"language": {
