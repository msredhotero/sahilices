...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-02-2019 a las 22:46:12
...
INSERT INTO `dbusuarios` (`idusuario`, `usuario`, `password`, `refroles`, `email`, `nombrecompleto`, `refcontactos`, `activo`, `refunidadesnegocios`) VALUES
(1, 'marcos', 'marcos', 1, 'msredhotero@msn.com', 'Marcos Safar', NULL, b'1', 0),
(2, 'guiddo', 'guido', 1, 'guiddone@gmail.com', 'GUIDO DE GIUST0', 0, b'1', 0);
