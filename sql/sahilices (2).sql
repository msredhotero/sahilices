...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-01-2019 a las 21:59:20
...
(10, 'Oportunidad en tiempo', 1, 'Sistema', 'msredhotero@msn.com', 1, 0, 0, 'alarm', 'orange', '2019-01-10 18:53:06', 'oportunidades/oportunidad.php?id=', b'0'),
(11, 'Oportunidad en tiempo', 1, 'Sistema', 'msredhotero@msn.com', 1, 0, 0, 'alarm', 'red', '2019-01-10 18:53:36', 'oportunidades/oportunidad.php?id=', b'0'),
(12, 'Demora de Oportunidad', 1, 'Sistema', 'msredhotero@msn.com', 4, 0, 0, 'alarm', 'red', '2019-01-25 15:14:46', 'oportunidades/oportunidad.php?id=', b'0'),
(13, 'Demora de Oportunidad', 1, 'Sistema', 'msredhotero@msn.com', 3, 0, 0, 'alarm', 'red', '2019-01-25 15:14:46', 'oportunidades/oportunidad.php?id=', b'0'),
(14, 'Demora de Oportunidad', 1, 'Sistema', 'msredhotero@msn.com', 2, 0, 0, 'alarm', 'red', '2019-01-25 15:14:46', 'oportunidades/oportunidad.php?id=', b'0'),
(15, 'Demora de Oportunidad', 1, 'Sistema', 'msredhotero@msn.com', 1, 0, 0, 'alarm', 'red', '2019-01-25 15:14:46', 'oportunidades/oportunidad.php?id=', b'0');
...
INSERT INTO `dboportunidades` (`idoportunidad`, `empresa`, `contacto`, `telefono`, `email`, `comentarios`, `reftipostrabajos`, `refmotivosoportunidades`, `observaciones`, `refusuarios`, `refestados`, `refcotizaciones`, `refsemaforos`, `refestadocotizacion`, `fechacreacion`) VALUES
(1, 'YPF', 'Juan Carlos', '0221 6184415', 'aranzazu@aif.org.ar', '', 4, 5, '', 1, 1, 0, 3, 1, '2019-01-09 21:38:47'),
(2, 'asdasd', 'asdasd', '23455345', 'aranzazu@aif.org.ar', '', 3, 4, '', 1, 1, 0, 3, 1, '2019-01-11 16:42:44'),
(3, 'EMPRESA 1', 'pepe', '1651649', 'aranjuez@aif.org.ar', '', 2, 6, '', 1, 1, 0, 3, 1, '2019-01-11 16:58:44'),
(4, 'EMPRESA 2', 'GASTON', '15 614588943', 'altosdelsol@aif.org.ar', '', 3, 3, '', 1, 1, 0, 3, 1, '2019-01-11 17:00:59');
...
--
-- Estructura de tabla para la tabla `dbusuariosperfiles`
--

CREATE TABLE IF NOT EXISTS `dbusuariosperfiles` (
`ibusuarioperfile` int(11) NOT NULL,
  `refusuarios` int(11) NOT NULL,
  `refcargos` int(11) NOT NULL,
...
(4, '../empleados/', 'person_pin', 'Empleados', 3, NULL, 'Administrador', b'1', b'1', b'1', 0),
...
(13, '../clientes/', 'person', 'Clientes', 3, NULL, 'Administrador', b'1', b'1', b'1', 0),
...
(16, '../oportunidades/', 'markunread_mailbox', 'Oportunidades', 6, NULL, 'Administrador', b'1', b'1', b'1', 0);
...
`idestadocotizacion` int(10) NOT NULL,
  `estadocotizacion` varchar(60) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
ALTER TABLE `dboportunidades`
 ADD PRIMARY KEY (`idoportunidad`), ADD KEY `fk_o_est_idx` (`refestados`), ADD KEY `fk_o_sem_idx` (`refsemaforos`), ADD KEY `fk_o_tt_idx` (`reftipostrabajos`), ADD KEY `fk_o_mo_idx` (`refmotivosoportunidades`);
...
--
-- Indices de la tabla `dbusuariosperfiles`
--
ALTER TABLE `dbusuariosperfiles`
 ADD PRIMARY KEY (`ibusuarioperfile`), ADD KEY `fk_up_u_idx` (`refusuarios`), ADD KEY `fk_up_c_idx` (`refcargos`), ADD KEY `fk_up_un_idx` (`refunidadesnegocios`);
...
--
ALTER TABLE `dboportunidades`
MODIFY `idoportunidad` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
-- AUTO_INCREMENT de la tabla `dbusuariosperfiles`
--
ALTER TABLE `dbusuariosperfiles`
MODIFY `ibusuarioperfile` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de la tabla `tbcargos`
--
ALTER TABLE `tbcargos`
...
--
ALTER TABLE `tbestadocotizacion`
MODIFY `idestadocotizacion` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `tbunidadesnegocios`
MODIFY `idunidadnegocio` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
...
--
-- Filtros para la tabla `dbusuariosperfiles`
--
ALTER TABLE `dbusuariosperfiles`
ADD CONSTRAINT `fk_up_c` FOREIGN KEY (`refcargos`) REFERENCES `tbcargos` (`idcargo`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_up_u` FOREIGN KEY (`refusuarios`) REFERENCES `dbusuarios` (`idusuario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_up_un` FOREIGN KEY (`refunidadesnegocios`) REFERENCES `tbunidadesnegocios` (`idunidadnegocio`) ON DELETE NO ACTION ON UPDATE NO ACTION;
