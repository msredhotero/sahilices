...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-04-2019 a las 00:07:27
...
(43, 7, 4, 1, '1815.00', '0.00', 1, 0, b'1', b'0', '', ''),
(44, 7, 5, 3, '4212.00', '0.00', 1, 0, b'1', b'0', '', ''),
(45, 7, 3, 1, '1815.00', '0.00', 1, 0, b'1', b'0', '', ''),
(46, 7, 7, 1, '0.00', '0.00', 1, 0, b'1', b'0', 'Nota mantenimiento', '1_ asodiasod  asda aspodasd aspdo sdfdg'),
(47, 7, 8, 1, '0.00', '0.00', 1, 0, b'1', b'0', 'Nota Calibracion', '2.-Nuestros servicios contemplan de ser necesario/requerido por el usuario/cliente ajuste y calibr'),
...
INSERT INTO `dbcotizacionmovimientos` (`idcotizacionmovimiento`, `refcotizaciondetalles`, `refconceptos`, `cantidad`, `preciounitario`, `porcentajebonificado`, `reftipomonedas`, `rango`, `aplicatotal`, `fechacrea`, `usuariocrea`, `concepto`, `leyenda`, `refestadocotizacion`) VALUES
(2, 46, 7, 1, '0.00', '0.00', 1, 0, b'1', '0000-00-00 00:00:00', 'Marcos Safar', 'Nota mantenimiento', '1_ asodiasod  asda aspodasd aspdo sdfdg', 1);
...
--
ALTER TABLE `dbconceptos`
MODIFY `idconcepto` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
...
--
ALTER TABLE `dbcotizaciondetalles`
MODIFY `idcotizaciondetalle` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=57;
--
-- AUTO_INCREMENT de la tabla `dbcotizaciondetallesaux`
--
ALTER TABLE `dbcotizaciondetallesaux`
MODIFY `idcotizaciondetalleaux` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `dbcotizacionmovimientos`
MODIFY `idcotizacionmovimiento` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `tbtipoconceptos`
MODIFY `idtipoconcepto` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
